...
public class stopvision40 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getSupportActionBar().hide();
        setContentView(R.layout.activity_stopvision40);
    }
    public void lreturnmain(View view) {
        Intent intent = new Intent(this, relax.class);
        startActivity(intent);
        final AVUser currentUser= AVUser.getCurrentUser();
        currentUser.put("Left_Vision","4.5");
    ...
    public void rreturnmain(View view) {
        ...
        startActivity(intent);
        final AVUser currentUser= AVUser.getCurrentUser();
        currentUser.put("Right_Vision","4.5");
        currentUser.saveInBackground();
        finish();
    }
}
